...
const cardGLB = '/models/card5z.glb';
// 🧩 Tetap bisa pakai png dari src
import lanyard from '../../assets/Lanyard/lanyard5z.png';

extend({ MeshLineGeometry, MeshLineMaterial });

export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
  return (
    <div className="relative z-5 w-full h-screen flex justify-center items-center transform scale-100 origin-center">
      <Canvas
