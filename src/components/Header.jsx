...
import Faiz5ZLogo from '../assets/images/5Z.png';
...
const Header = () => {
  ...
  const NavLink = ({ href, children }) => (
    <li>
      ...
      >
        {children}
        <span className="absolute bottom-1 left-0 block h-[2px] w-0 bg-[#ff3c00] transition-all duration-500 group-hover:w-full"></span>
      </a>
    </li>
  );
      ...
      <AnimatePresence>
        {isNavbarVisible && (
          ...
          >
            ...
            {!isScrolled && (
              <div
                ...
                style={{
                  ...
                  clipPath: CLIP_PATH,
                  background: 'linear-gradient(90deg, #ff0000, #ff6a00, #fff700, #ff6a00, #ff0000)',
                  backgroundSize: '300% 100%',
                  animation: 'gradientShadowMove 6s linear infinite',
                  opacity: 1,
                  filter: 'drop-shadow(0 16px 24px rgba(255,64,0,0.35))',
                }}
              ></div>
            )}
            ...
            {/* Navbar */}
            <header
              className={`pt-3 pb-3 navbar-fire-underline relative z-20 pointer-events-auto transition-all duration-300
                ${isScrolled
              ...
              <nav className="container mx-auto flex items-center justify-between flex-wrap pb-4 px-4">
                ...
                <div className="w-full flex items-center justify-between md:hidden">
                  ...
                  <a href="#home" className="flex items-center gap-3">
                    <img src={Faiz5ZLogo} alt="Faiz5Z Logo" className="h-12 w-12 flex-shrink-0" />
                    <div>
                      <h1 className="font-moderniz text-sm text-[#ff6a00] whitespace-nowrap">Faiz Arya Putra</h1>
                      <p className="font-moderniz text-[9px] text-[#400000]" style={{
                        textShadow: '0.5px 0.5px 0 #ff6a00, -0.5px -0.5px 0 #ff3c00, 0.5px -0.5px 0 #ff0000, -0.5px 0.5px 0 #ff3c00'
                      }}>
                ...
                <div className="hidden w-full md:flex items-center justify-around">
                  ...
                  <a href="#home" className="flex items-center gap-3">
                    <img src={Faiz5ZLogo} alt="Faiz5Z Logo" className="h-12 w-12" />
                    <div className="block">
                      <h1 className="font-moderniz text-base text-[#ff6a00]">Faiz Arya Putra</h1>
                      <p
                        className="font-moderniz text-[10px] text-[#400000]"
                        style={{
                          textShadow:
                            '0.5px 0.5px 0 #ff6a00, -0.5px -0.5px 0 #ff3c00, 0.5px -0.5px 0 #ff0000, -0.5px 0.5px 0 #ff3c00'
                        }}
                      >
                        Let's see the awesome Experience
                      </p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-slate-400 hover:text-orange-400 transition-colors duration-300 pointer-events-auto"
                      title={isAuthenticated ? "Admin Dashboard" : "Admin Login"}
                    >
                      <FaShieldAlt className={`text-lg ${isAuthenticated ? 'text-yellow-400' : 'text-orange-400'}`} />
                    </button>
                  </div>
                </div>
      ...
      {showAdminDashboard && (
        <div className="fixed bottom-6 right-6 z-[60] flex flex-col gap-2">
          <button
            ...
            className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-500 hover:to-red-500 text-white px-4 py-2 rounded-full shadow-lg transition-all duration-300 flex items-center gap-2"
          >
